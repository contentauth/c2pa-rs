...
| **PdfIO** (PDF) | Y | -- | Y | -- | -- | Y | -- |
| **OggIO** (OGG, Opus) [^ogg] | Y | Y | Y | -- | Y | -- | Y |

[^ogg]: Experimental — compiled only with the `unstable_ogg` feature. See the [experimental features policy](../../../docs/experimental-features.md).
