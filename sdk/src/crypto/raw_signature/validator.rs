...
use crate::crypto::raw_signature::{
    oids::{
        ...
        ED25519_OID, SHA1_OID, SHA1_WITH_RSAENCRYPTION_OID, SHA256_OID,
        SHA256_WITH_RSAENCRYPTION_OID, SHA384_OID, SHA384_WITH_RSAENCRYPTION_OID, SHA512_OID,
        SHA512_WITH_RSAENCRYPTION_OID,
    },
    SigningAlg,
};
