...
mod tests {
    ...
    const NESTED_LINUX: &[u8] =
        include_bytes!("../tests/fixtures/cross-compatibility-zip/nested.linux.zip");
    const NESTED_MACOS: &[u8] =
        include_bytes!("../tests/fixtures/cross-compatibility-zip/nested.macos.zip");
    const NESTED_WINDOWS: &[u8] =
        include_bytes!("../tests/fixtures/cross-compatibility-zip/nested.windows.zip");

    const UNICODE_COMPOSED_LINUX: &[u8] = include_bytes!(
        "../tests/fixtures/cross-compatibility-zip/crossplatform-fixtures-ubuntu-latest/unicode-composed.zip"
    );
    const UNICODE_COMPOSED_MACOS: &[u8] = include_bytes!(
        "../tests/fixtures/cross-compatibility-zip/crossplatform-fixtures-macos-latest/unicode-composed.zip"
    );
    const UNICODE_COMPOSED_WINDOWS: &[u8] = include_bytes!(
        "../tests/fixtures/cross-compatibility-zip/crossplatform-fixtures-windows-latest/unicode-composed.zip"
    );

    const UNICODE_DECOMPOSED_LINUX: &[u8] = include_bytes!(
        "../tests/fixtures/cross-compatibility-zip/crossplatform-fixtures-ubuntu-latest/unicode-decomposed.zip"
    );
    const UNICODE_DECOMPOSED_MACOS: &[u8] = include_bytes!(
        "../tests/fixtures/cross-compatibility-zip/crossplatform-fixtures-macos-latest/unicode-decomposed.zip"
    );
    const UNICODE_DECOMPOSED_WINDOWS: &[u8] = include_bytes!(
        "../tests/fixtures/cross-compatibility-zip/crossplatform-fixtures-windows-latest/unicode-decomposed.zip"
    );

    #[test]
    fn nested_signed_on_linux() -> Result<()> {
        let mut stream = Cursor::new(NESTED_LINUX);
    ...
    #[test]
    fn nested_signed_on_macos() -> Result<()> {
        let mut stream = Cursor::new(NESTED_MACOS);
        let reader = Reader::from_context(test_context()).with_stream("zip", &mut stream)?;
    ...
    #[test]
    fn nested_signed_on_windows() -> Result<()> {
        let mut stream = Cursor::new(NESTED_WINDOWS);
        let reader = Reader::from_context(test_context()).with_stream("zip", &mut stream)?;
    ...
    #[test]
    fn unicode_composed_signed_on_linux() -> Result<()> {
        let mut stream = Cursor::new(UNICODE_COMPOSED_LINUX);
        let reader = Reader::from_context(test_context()).with_stream("zip", &mut stream)?;
    ...
    #[test]
    fn unicode_composed_signed_on_macos() -> Result<()> {
        let mut stream = Cursor::new(UNICODE_COMPOSED_MACOS);
        let reader = Reader::from_context(test_context()).with_stream("zip", &mut stream)?;
    ...
    #[test]
    fn unicode_composed_signed_on_windows() -> Result<()> {
        let mut stream = Cursor::new(UNICODE_COMPOSED_WINDOWS);
        let reader = Reader::from_context(test_context()).with_stream("zip", &mut stream)?;
    ...
    #[test]
    fn unicode_decomposed_signed_on_linux() -> Result<()> {
        let mut stream = Cursor::new(UNICODE_DECOMPOSED_LINUX);
        let reader = Reader::from_context(test_context()).with_stream("zip", &mut stream)?;
    ...
    #[test]
    fn unicode_decomposed_signed_on_macos() -> Result<()> {
        let mut stream = Cursor::new(UNICODE_DECOMPOSED_MACOS);
        let reader = Reader::from_context(test_context()).with_stream("zip", &mut stream)?;
    ...
    #[test]
    fn unicode_decomposed_signed_on_windows() -> Result<()> {
        let mut stream = Cursor::new(UNICODE_DECOMPOSED_WINDOWS);
        let reader = Reader::from_context(test_context()).with_stream("zip", &mut stream)?;
