...
use crate::{
    ...
    read_seek::ReadSeek,
    utils::hash_utils::{
        default_hash_buf, hash_stream_by_alg, hash_stream_by_alg_with_progress, vec_compare,
        verify_asset_by_alg, verify_by_alg, HashRange,
    },
};
...
impl DataHash {
        ...
        F: FnMut(u32, u32) -> Result<()>,
    {
        ...
        let hash =
            hash_stream_by_alg_with_progress(&alg, stream, exclusions, true, progress, max_hash_buf)?;
