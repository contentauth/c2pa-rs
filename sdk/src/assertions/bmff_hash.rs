...
use crate::{
    ...
    utils::{
        hash_utils::{
            concat_and_hash, hash_by_alg, hash_stream_by_alg, hash_stream_by_alg_with_progress,
            vec_compare, verify_stream_by_alg, HashRange, Hasher,
        },
        io_utils::stream_len,
...
impl BmffHash {
    ...
    /// hashes via repeated [`MerkleAccumulator::add_merkle_leaf`] calls (e.g.
    /// from `Builder::hash_bmff_mdat_bytes`).
    ///
    ...
    /// the tree shape via [`MerkleMap::create_mms_from_mdat_leaves`].
    ///
