...
mod integration_1 {
    ...
    fn test_embed_manifest() -> Result<()> {
        ...
        parent_path.push("tests/fixtures/jpeg/earth_apollo17.jpg");
        let mut ingredient_path = PathBuf::from(env!("CARGO_MANIFEST_DIR"));
        ingredient_path.push("tests/fixtures/png/libpng-test.png");
    ...
    fn test_embed_json_manifest() -> Result<()> {
        ...
        parent_path.push("fixtures/jpeg/earth_apollo17.jpg");
    ...
    fn test_placed_manifest_bmff() -> Result<()> {
        ...
        manifest_path.push("manifest.json");
        let mut parent_path = fixture_path.clone();
        parent_path.push("fixtures/bmff/video1.mp4");
