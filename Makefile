...
test-wasm-web:
	cd sdk && WASM_BINDGEN_TEST_TIMEOUT=60 CHROMIUM_ARGS="--no-sandbox --disable-dev-shm-usage --disable-gpu" CHROMEDRIVER_ARGS="--whitelisted-ips=" wasm-pack test --chrome --headless -- --no-default-features --features="rust_native_crypto, fetch_remote_manifests"
