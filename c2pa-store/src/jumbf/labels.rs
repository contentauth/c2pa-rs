...
pub fn to_manifest_uri(manifest_label: &str) -> String {
    format!("{JUMBF_PREFIX}=/{MANIFEST_STORE}/{manifest_label}")
}

// Converts a manifest label and an assertion label into a JUMBF URI.
pub fn to_assertion_uri(manifest_label: &str, assertion_label: &str) -> String {
    format!(
        "{}/{}/{}",
...
pub fn to_signature_uri(manifest_label: &str) -> String {
...
pub fn to_verifiable_credential_uri(manifest_label: &str, vc_id: &str) -> String {
...
// HashedURI.
pub fn to_databox_uri(manifest_label: &str, databox_id: &str) -> String {
    // TO CONSIDER: Does this now belong in jumbf::labels?
    format!(
        "{}/{}/{}",
        to_manifest_uri(manifest_label),
...
pub fn to_normalized_uri(uri: &str) -> String {
...
pub fn to_absolute_uri(manifest_label: &str, uri: &str) -> String {
...
pub fn to_relative_uri(uri: &str) -> String {
    let raw_uri = to_normalized_uri(uri);
    let parts: Vec<&str> = raw_uri.split('/').collect();
...
pub fn box_name_from_uri(uri: &str) -> Option<String> {
    let raw_uri = to_normalized_uri(uri);
    let parts: Vec<&str> = raw_uri.split('/').collect();
...
pub fn manifest_label_to_parts(uri: &str) -> Option<ManifestParts> {
