...
cargo build --target="$arch-pc-windows-msvc" -p c2pa-c-ffi --release --no-default-features --features "rust_native_crypto, file_io, http, add_thumbnails,fetch_remote_manifests"
