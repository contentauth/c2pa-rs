...
The specified algorithm must be compatible with the values of private key and signing certificate.  For more information, see [Signing and certificates](https://opensource.contentauthenticity.org/docs/signing/).
