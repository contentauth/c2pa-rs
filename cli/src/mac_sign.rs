...
// create the key, if the key already exists it will be deleted and recreated
pub fn create_enclave_key(
    ...
    unsafe {
        ...
        let delete_dict  = CFDictionary::<CFType, CFType>::from_slices(
            &[
                kSecClass.as_ref(),
