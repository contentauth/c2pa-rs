...
## 0.24.1
_21 June 2023_
* remove User and UserCbor assertions from public API. They were not generating correct manifest data.
* use manifest.add_assertion or manifest_add_labeled_assertion instead.
## 0.24.0
_21 June 2023_
