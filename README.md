...
Minimal supported Rust version (MSRV): The `c2pa` crate requires Rust version 1.89.0 or newer. When a newer version of Rust becomes required, a new minor (0.x.0) version of this crate will be released.
