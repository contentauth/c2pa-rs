...
----
"@context": {
  "@vocab": "https://https://contentcredentials.org/crjson",
  "extras": "https://https://contentcredentials.org/crjson/extras"
}
----
...
==== 5.5.1 Included assertion sources
...
==== 5.5.2 Labeling and instance rules
...
==== 5.5.3 Binary normalization and hash encoding
...
==== 5.5.4 Gathered binary assertion representation
...
=== 5.8 `extras:validation_status` (global)
...
* CrJSON does not include `asset_info`, `content`, or `metadata`; the root object contains only `@context`, `manifests`, and optionally `extras:validation_status`.
